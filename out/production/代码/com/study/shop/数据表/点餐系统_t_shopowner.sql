...
--
-- Table structure for table `t_shopowner`
--

DROP TABLE IF EXISTS `t_shopowner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_shopowner` (
  `shop_id` int NOT NULL COMMENT '店主编号',
  `address` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '地址',
  `shopowner` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '店主',
...
--
-- Dumping data for table `t_shopowner`
--

LOCK TABLES `t_shopowner` WRITE;
/*!40000 ALTER TABLE `t_shopowner` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_shopowner` ENABLE KEYS */;
UNLOCK TABLES;
